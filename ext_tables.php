...
$TCA['tx_nkhyphenation_domain_model_hyphenationpatterns'] = array(
    'ctrl' => array(
        ...
        'dynamicConfigFile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY) . 'Configuration/Tca/hyphenationpatterns.php',
        'iconfile'          => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY) . 'Resources/Public/Icons/hyphenationpatterns.png',
